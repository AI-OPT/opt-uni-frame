...
<div id="page-wrapper" class="container">
    ...
    <!--右侧-->
     ...
     <iframe id="content-wrapper-iframe" name="mainFrame"  src="" style="overflow:visible;"  frameborder="0"  scrolling="no" marginheight="0" width="100%" marginwidth="0" onLoad="iFrameHeight()"></iframe>
